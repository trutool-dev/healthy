/**
 * OnboardingGoal — paso 1/7: selección del objetivo principal
 */
...
const GOALS: { value: Goal; icon: string; label: string; sublabel: string }[] = [
  {
    ...
    icon:     '🔥',
    label:    'Perder peso',
    sublabel: 'Quema grasa de forma sostenible',
  },
  {
    value:    'gain_muscle',
    icon:     '💪',
    label:    'Ganar músculo',
    sublabel: 'Mejora tu fuerza y composición corporal',
  },
  {
    value:    'stay_active',
    icon:     '🧘',
    label:    'Mantenerme activo',
    sublabel: 'Hábitos saludables para el día a día',
  },
  {
    value:    'improve_habits',
    icon:     '🌱',
    label:    'Mejorar mis hábitos',
    sublabel: 'Alimentación y bienestar general',
  },
];
